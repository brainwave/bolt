//Source from https://ravehgonen.wordpress.com/tag/stl-file-format/
//
#include <fstream>
#include <string>
#include <vector>
...
public:
    ...
    // move 3D Model coordinates to be center around COG(0,0,0) -- How is half of upper-lower the COG? Its a triangle, not a square. Consult and change--bpm
    void normalize() {
