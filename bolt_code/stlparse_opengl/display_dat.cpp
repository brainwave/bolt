...
int showSlice(string filename, string extension, int counter, const GLfloat x_scale, const GLfloat y_scale, const GLfloat z_scale ) 
{
	...
	glm::mat4 glm_tm = glm::scale(glm::mat4(1.0),glm::vec3(x_scale,y_scale,z_scale));
...
int showWindow(GLFWwindow* window, const GLfloat xscale = 1.0f, const GLfloat yscale = 1.0f, const GLfloat zscale = 1.0f) {
	...
	showSlice(".slice_",".dat",cur_slice_no++, xscale, yscale, zscale );	
